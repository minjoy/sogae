  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        {/* 진행 상황 안내 */}
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-5 text-center text-white mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 mb-6">
          ...
          <div className="rounded-xl overflow-hidden">
            <iframe
              src="https://ads-partners.coupang.com/widgets.html?id=964752&template=carousel&trackingCode=AF2407547&subId=TestResult&width=684&height=140&tsource="
              width="684"
              height="140"
              frameBorder="0"
              scrolling="no"
