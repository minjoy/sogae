    ...
    try {
      ...
      if (data.success) {
        ...
        if (!saveResponse.ok) {
          ...
          router.replace('/face-measure/result');
          return;
        }
        ...
        if (saveData.success) {
          ...
          router.replace(`/face-measure/result/${saveData.shareCode}`);
        } else {
          // DB 저장 실패 시 기존 방식으로 폴백
          sessionStorage.setItem('faceAnalysisResult', JSON.stringify({
            result: data.result,
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#EDF4F8' }}>
        <div className="container mx-auto px-4 py-8 max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">얼굴 정밀 측정</h1>
            <p className="text-gray-600">
              AI 기반 얼굴 랜드마크 분석으로
            </p>
            <p className="text-gray-600">
              정밀한 얼굴 계측 데이터를 제공합니다
            </p>
